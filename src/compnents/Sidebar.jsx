      ...
      <div className="sidebar--content">
        ...
        <div className="sidebar--user">
          <div className="sidebar--user__content">
            <div onClick={() => setProfileDisplay(!profileDisplay)} className="sidebar--user__info">
          ...
          {profileDisplay && <div className="user--profile">
          <div className="sidebar--user__content user--profile__info">
            <figure className="user--logo user--profile__logo">
              <img src={user.photoURL} />
            </figure>
            <p className="user--name user--profile__name">{user && user.displayName}</p>
          </div>
          <div className="user--profile__block">
            <div className="profile--block__section"><h5>Email</h5>
              <p>{user && user.email}</p>
             </div>
             <div className="profile--block__section"><h5 className="block__section--mini-title">Rhycon member since</h5>
              <p>{user && user.metadata.creationTime}</p>
             </div>
             <div className="profile--block__section"><h5 className="block__section--mini-title">Ranks</h5>
              <p>coming soon</p>
             </div>
          </div>
          </div>}
