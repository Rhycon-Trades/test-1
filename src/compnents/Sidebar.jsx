      ...
      <div className="sidebar--content">
        <ul className="sidebar--channels">
          <li className="sidebar--channels__items">
            ...
            <button className="channels__btn">
              <Link to="/app">Introduction</Link>
            </button>
            <button className="channels__btn">
              <Link to="/app">faq</Link>
            </button>
            <button className="channels__btn">
              <Link to="/app">announcments</Link>
            </button>
            <button className="channels__btn">
              <Link to="/app">results</Link>
            </button>
          </li>
          <li className="sidebar--channels__items">
            <h6 className="channels__header">Text channels</h6>
            <button className="channels__btn">
              <Link to="/app">General chat</Link>
            </button>
            <button className="channels__btn">
              <Link to="/app">begginer 's chat</Link>
            </button>
            <button className="channels__btn">
              <Link to="/app">ask a mentor</Link>
            </button>
          </li>
          <li className="sidebar--channels__items">
            <h6 className="channels__header">interactive</h6>
            <button className="channels__btn">
              <Link to="/app">claim roles</Link>
            </button>
            <button className="channels__btn">
              <Link to="/app">polls</Link>
            </button>
            <button className="channels__btn">
              <Link to="/app">check invites</Link>
            </button>
          </li>
        </ul>
